            ...
            <Navbar bg="dark" variant="dark" expand="sm">
                ...
                <Navbar.Collapse className="justify-content-end">
                    <Nav>
                        {
                            auth ? (
                                <NavDropdown id="navbar-user-dropdown" title={(auth.idTokenData as any).preferred_username}>
                                    <NavDropdown.Item onClick={OnClickSignOutCallback}>Sign out</NavDropdown.Item>
                                </NavDropdown>
                            ) : (
