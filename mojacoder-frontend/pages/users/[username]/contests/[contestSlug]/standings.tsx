...
const GetContestStandingsWithDetail = gql`
    query GetContestStandingsWithDetail(
        $username: String!
        $contestSlug: String!
    ) {
        user(username: $username) {
    ...
    useEffect(() => {
        const loadTasks = async () => {
            ...
            const {
                ...
                ? await invokeQuery(GetContestStandingsWithDetail, args)
                : await invokeQueryWithApiKey(GetContestStandings, args)
